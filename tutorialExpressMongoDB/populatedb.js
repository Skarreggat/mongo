...
////////////////////////////////////////////////////ALEX///////////////////////
function formatoCreate(name, cb) {
  var formato = new Formato({ name: name });
  ...
  formato.save(function (err) {
    ...
    console.log('New Formato: ' + formato);
